"""
Preprocess WebQSP dataset for agent benchmarking.
...
Usage:
    python data/atomic_kbqa/webqsp/scripts/preprocess_webqsp.py
"""
...
def assign_to_bin(workflow_length: int) -> int:
    ...
    Dataset-specific binning logic for WebQSP.

    Bins:
        0: [2-3] # note: there is no 1-length workflow in WebQSP
        1: [4-5]
        2: [6-7]
        3: [8+]
    Args:
...
def preprocess_split(
    ...
    """
    Preprocess a single dataset split (train or test) for WebQSP.

    Wrapper around run_preprocessing from utils with WebQSP-specific binning logic.
...
def main(args):
    """Main preprocessing workflow for WebQSP."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Preprocess WebQSP dataset for agent benchmarking"
    )
    parser.add_argument(
        "--train-input",
        dest="train_input",
        type=str,
        default="data/atomic_kbqa/webqsp/WebQSP_train.json",
    ...
    parser.add_argument(
        ...
        dest="train_output",
        type=str,
        default="data/atomic_kbqa/webqsp/processed/webqsp_train.v1.json",
    ...
    parser.add_argument(
        ...
        type=str,
        default="data/atomic_kbqa/webqsp/processed/WebQSP_train_heldout_pool.v1.json",
    ...
    parser.add_argument(
        ...
        dest="test_input",
        type=str,
        default="data/atomic_kbqa/webqsp/WebQSP_test.json",
    ...
    parser.add_argument(
        ...
        dest="test_output",
        type=str,
        default="data/atomic_kbqa/webqsp/processed/webqsp_test.v1.json",
