"""
Preprocess GraphQ dataset for agent benchmarking.
...
def assign_to_bin(workflow_length: int) -> int:
    ...
    Dataset-specific binning logic for GraphQ.

    Bins:
        0: [2-3] # note: there is no 1-length workflow in GraphQ
        1: [4-5]
        2: [6-7]
        3: [8+]
    Args:
...
def preprocess_split(
    ...
    """
    Preprocess a single dataset split (train or test) for GraphQ.
    Wrapper around run_preprocessing from utils with GraphQ-specific binning logic.
...
def main(args):
    """Main preprocessing workflow for GraphQ."""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(
        description="Preprocess GraphQ dataset for agent benchmarking"
    )
    parser.add_argument(
        "--train-input",
        dest="train_input",
        type=str,
        default="data/atomic_kbqa/graphq/GraphQ_train.json",
    ...
    parser.add_argument(
        ...
        dest="train_output",
        type=str,
        default="data/atomic_kbqa/graphq/processed/graphq_train.v1.json",
    ...
    parser.add_argument(
        ...
        type=str,
        default="data/atomic_kbqa/graphq/processed/graphq_train_heldout_pool.v1.json",
    ...
    parser.add_argument(
        ...
        dest="test_input",
        type=str,
        default="data/atomic_kbqa/graphq/GraphQ_test.json",
    ...
    parser.add_argument(
        ...
        dest="test_output",
        type=str,
        default="data/atomic_kbqa/graphq/processed/graphq_test.v1.json",
